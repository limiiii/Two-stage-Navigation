...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /home/yang/lim-ws/src/fusion)
  set(fusion_DEVEL_PREFIX /home/yang/lim-ws/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /home/yang/lim-ws/install)
...
if(NOT "/home/yang/lim-ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'rob <rob@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/lim-ws/src/fusion/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT fusion_NUM_DUMMY_TARGETS)
      set(fusion_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::fusion::wrapped-linker-option${fusion_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR fusion_NUM_DUMMY_TARGETS "${fusion_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::fusion::wrapped-linker-option${fusion_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND fusion_LIBRARIES "${interface_target_name}")
...
set(fusion_EXPORTED_TARGETS "fusion_generate_messages_cpp;fusion_generate_messages_eus;fusion_generate_messages_lisp;fusion_generate_messages_nodejs;fusion_generate_messages_py")
...
set(depends "autoware_msgs;roscpp;std_msgs;message_runtime;rospy;sensor_msgs;cv_bridge;tf2_ros;tf2_geometry_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(fusion_EXPORTED_TARGETS ${${fusion_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "fusion-msg-extras.cmake")
