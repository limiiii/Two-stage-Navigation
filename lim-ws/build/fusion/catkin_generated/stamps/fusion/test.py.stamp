...
#测试获取的导航点数据
    #print('getting the target pose......')
    #room_list = load_points()
    #print("test for the pose data......")
    #for pose in room_list:
        #print(pose.pose.position.x, pose.pose.position.y, pose.pose.orientation.z, pose.pose.orientation.w)